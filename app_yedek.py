...
def start_scan():
    ...
    # Here you would normally call your crawler and manipulation components
    ...
    # Simulate scan results (in a real app, this would come from your scanner)
    vulnerabilities = []
    for url in urls[:5]:  # Limit to 5 URLs for demo
        ...
        if "example.com" in url:
            ...
            vulnerabilities.append({
                ...
                'evidence': "Returned database records"
            })
